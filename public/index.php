        ...
        <div class="row mt-2">
            ...
            <div class="col-4">
                <ul class="list-group">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Snapcraft Release: <span class="<?=$snap_status['release']?>"><?=$snapcraft["release"]?></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                    ...
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Play Store Release: <span class="<?=$play_status['release']?>"><?=$play_store_release?></span>
                    </li>
                    <li class="list-group-item d-flex justify-content-between align-items-center">
                        Play Store Beta: <span class="<?=$play_status['beta']?>"><?=$play_store_beta?></span>
                    </li>
                </ul>
            </div>
        </div>
